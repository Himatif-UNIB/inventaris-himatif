...
<head>
    ...
    <link rel="icon" href="https://himatifunib.org/storage/156/himatif-6000_small.png" type="image/png">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            <img src="https://himatifunib.org/storage/156/himatif-6000_small.png" class="my-4" style="height: 90px;" alt="">
                            <p class="text-lead text-white">SISTEM INFORMASI INVENTARIS<br>HIMPUNAN MAHASISWA TEKNIK INFORMATIKA</p>
                        </div>
                    </div>
                </div>
            </div>
